...
def main():
    ...
    if (len(sys.argv) > 1):
        ...
        # L = Loader("in/kittens.in", 10000, 1)  # 10k vids, 200k reqs, 1000 ep's, 500 srvrs0
        # L = Loader("in/example.in", 100,100,1)
        L = Loader("in/me_at_the_zoo.in", 100, 1) # 100 vids, 100 reqs, 10 ep's, 10 srvrs
        # L = Loader("in/videos_worth_spreading.in", 10000, 1) # 10k vids, 100k reqs, 100 ep's, 100 srvrs
        # L = Loader("in/trending_today.in", 100, 10000, 1) # 10k vids, 100k reqs, 100 ep's, 100 srvrs
