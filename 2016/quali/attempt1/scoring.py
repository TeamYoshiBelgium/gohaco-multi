...
class Score(object):
    ...
    def addScore(self):
        partialScore = math.ceil((self.T - self.time) * 100 / self.T)
...
listResults =[]
listResults.append(JudgeSystem("in/mother_of_all_warehouses.in", "out/mother_of_all_warehouses.77714.out").score)
